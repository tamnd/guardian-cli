...
Most of these come down to network reality or how guardian serves its data,
not a bug. Fill this page out with the site-specific cases as you find them.

## Requests start failing or returning 429

guardian rate-limits like any public site. guardian already paces
...
Where a surface is gated, guardian reads a cookie or token you supply
...
`guardian`, add that directory to your `PATH`. See
[installation](/getting-started/installation/).

## Seeing what guardian actually did
