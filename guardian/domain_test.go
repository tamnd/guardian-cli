...
// HTTP behaviour is covered in guardian_test.go.
...
func TestHostWiring(t *testing.T) {
	...
	if want := "guardian://page/wiki/Go"; u.String() != want {
	...
	got, err := h.ResolveOn("guardian", "about")
	if err != nil || got.String() != "guardian://page/about" {
		t.Errorf("ResolveOn = (%q, %v), want guardian://page/about", got.String(), err)
	}
}
